 ...
 */
export declare type OptionsConfiguration = {
    /**
     * 页面标题
     * 新增、编辑弹窗标题
     */
    ...
    table?: {
      ...
      */
       ...
       */
        operators?: (row: any, { UpdateRender, DeleteRender }: {
            UpdateRender: any;
            DeleteRender: any;
...
export declare type RendererQueryProps = {
    model: any;
    value: any;
} & ExtraProps;
export declare type RendererTableProps = {
    key: string;
    value: any;
} & ExtraProps;
 ...
 * 每个字段对应的相关信息
 */
export declare type Templates = BaseTemplate & TableTemplate & FormTemplate & FilterTemplate & RendererTemplate & ExtraProps;
/**
 * 表格模板
 */
...
export declare type FormItem = 'input' | 'select' | 'datePicker' | 'datePickerRange';
