...
export interface TableRenderer {
    render: (props: TableRenderProps) => (props: {
        data: Ref<any>;
        loading: Ref<boolean>;
        border: boolean;
        onSelectionChange: (p: any) => any;
    }) => VNode;
 ...
 * 表格渲染器接口
 */
export declare type FormItemExtra<cmpName extends string, cmp extends Component> = {
    [key in cmpName]: cmp;
};
export declare type FormCompProps = Partial<FormTemplate> & {
    model: any;
    value: any;
};
export interface FormRenderer extends FormItemExtra<any, any> {
    create: (props: FormRenderProps) => {
        render: Component | any;
        model: any;
        formRef: Ref<any>;
    };
    getModel: (templates: Templates[]) => Record<string, any> | Ref<Record<string, any>>;
    getFromItems: (templates: Templates[], model: any, shouldWarpEvenly: any) => VNode[];
...
export interface DialogRenderProps {
    ...
    onUpdate?: (scope: any) => void;
    onCancel?: (scope: any) => void;
}
...
export declare type ExtraRenderer = Component[] | Element[] | VNode[];
